...
This program run for the 2^32 keyspace within a minute on an average computer and finds many possible *xi* values (x1: 17, x2: 17, x3: 1, x4: 33), but there is only one *x3*: *x3* = 1693001189.
